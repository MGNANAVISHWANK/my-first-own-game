...
var gameState=PLAY;
var Door,DoorImage;
var left,right,leftbutton,Rightbutton;
var DoorGroup;
...
function preload(){
  ...
  Rightbutton = loadImage("right button.png");
}
...
createCanvas(600,600);
  ...
  Ghost.scale=0.3
  left = createSprite(150,200);
  left.addImage(leftbutton);
  left.scale=0.1
  right = createSprite(450,200);
  right.addImage(Rightbutton);
  right.scale=0.4
